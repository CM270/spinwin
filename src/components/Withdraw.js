...
import TotalMATIC from "./TotalMATIC";
import SelectAmount from "./SelectAmount";
import Logo from "../images/Spin&Win.png"
  ...
  const WithdrawTokens = ({price, account, balance}) => {
    ...
    return (
      ...
      <div>
      <img src={Logo} alt="Logo Spin&Win" />
    </div>
        </Grid>
        </Grid>
    <Grid item xs={12}>
        ...
        <Grid container spacing={2}>
          ...
          <TotalMATIC tokenAmount={tokenAmount.value} price={price} msg={'You will receive'}/>
          </Grid>
